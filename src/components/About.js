...
class About extends React.Component {
  ...
  render() {
    ...
    return (
        ...
        <div className="bio"><p className="headline">Mission</p><p className="interests-body">As a software engineer I dedicate the same passion and grit I gave to mastering one craft to another - computer programming. I have mountains to learn and I am ecstatic climb them during what I believe is our generation’s equivalent of the industrial revolution. I see software as just another way to make things with another set of tools to learn - a challenge I deeply needed.  What fulfills me is building important things for the world with an inspired team with which I can grow and help grow.</p></div>
        <div className="interests"><p className="headline">Interests</p><p className="interests-body">When not dissecting the philosophical amplifications of art and tech, you’ll find me studying augmented reality, computer vision, AWS, Javascript, and computer science concepts. I plan to continue being a lifelong student and participate more deeply in the tech community. I love all things art and craft. Engineering has made me a better artist. Art has made me a better engineer. </p></div>
